    ...
    <Panel title="白条福利" class="pa">
      <ul>
        <li>
          ...
          <router-link :to="{path:'/demo'}" tag="em">立即开通 ></router-link>
        </li>
        <li>
          ...
          <router-link :to="{path:'/demo'}" tag="em">随机立减 ></router-link>
        </li>
        <li>
          ...
          <router-link :to="{path:'/demo'}" tag="em">去提额 ></router-link>
        </li>
      </ul>
    </Panel>
  </div>
